    ...
    print("""
           <body>
               ...
               <div class="sidebar" id="sidebar">
                   ...
                   <div class="menu-item">
                       <a href="./profile.html" style="text-decoration: none;color:var(--text-color);">
               ...
               <div class="content" id="content">
                     <h2 class="page-title text-center">Dealer Profile</h2>
     ...
     """ % (i[0], i[8], i[1], i[2], i[3], i[4], i[5], i[0], i[0]))
