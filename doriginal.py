    ...
    print("""
           <div class="content" id="content">
               <div class="page-container">
                   <h2 class="section-header">Approved Dealer</h2>
...
x = """select * from dealer where status='approved' """
cur.execute(x)
res = cur.fetchall()
for i in res:
    dealer_id = i[0]
...
if Submit != None:
    ...
    a = """update dealer set status="rejected",username='',password='' where Id='%s' """ % (dealer_id)
    cur.execute(a)
    con.commit()
    ...
    try:
        ...
        window.location.href = "doriginal.py?id=%s";
        </script>
        """ % (Id))
