...
<body>
   ...
   <section class="hero-section">
    ...
    <section class="contact-intro">
        <h2>Get In Touch</h2>
        <p>Whether you're interested in our premium textile products, seeking a custom solution for your business, or want to explore partnership opportunities, our team is ready to assist you. We value every inquiry and are committed to providing timely and helpful responses.</p>
    </section>
    ...
    <div class="contact-container">
        ...
        <section class="contact-info-section">
            ...
            <div class="contact-info text-align text-center ">
                <div class="info-item">
                    <div class="info-icon">
                    ...
                    <div class="info-content">
                        ...
                        <p><strong>Tiruppur:</strong> 123 SIDCO Industrial Estate, Tiruppur<br>Tamil Nadu, India - 641606</p>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h4>Phone Number</h4>
                        <p><a href="tel:+919876543210">+91 98765 43210</a> (Tiruppur)</p>
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h4>Email Address</h4>
                        <p><a href="mailto:info@sutlejhome.com">infoflorisknits.com</a></p>
                        <p><a href="mailto:sales@sutlejhome.com">sales@sflorisknits.com</a></p>
                    </div>
                </div>
                ...
                <div class="social-links">
                    ...
                    <div class="social-icons">
                        <a href="https://www.facebook.com/floris" class="social-icon"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://twitter.com/floris" class="social-icon"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.instagram.com/floris" class="social-icon"><i class="fab fa-instagram"></i></a>
    ...
    <section class="map-section">
        <div class="map-section-header">
            <h3 class="map-title">Find Our Locations</h3>
        </div>
        ...
        <div class="dual-maps">
            ...
            <div class="map-card">
                <div class="map-card-header">
                    <h4 class="map-card-title">Tiruppur Manufacturing Unit</h4>
                    <p class="map-card-address">123 SIDCO Industrial Estate, Tiruppur, Tamil Nadu - 641606</p>
                </div>
                <div class="map-iframe">
                    ...
                    <svg width="100%" height="100%" viewBox="0 0 600 350" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <line x1="100" y1="50" x2="500" y2="50" stroke="#d0d0d0" stroke-width="12" />
                        <line x1="100" y1="150" x2="500" y2="150" stroke="#d0d0d0" stroke-width="12" />
                        <line x1="100" y1="250" x2="500" y2="250" stroke="#d0d0d0" stroke-width="12" />
                        <line x1="200" y1="20" x2="200" y2="330" stroke="#d0d0d0" stroke-width="12" />
                        <line x1="300" y1="20" x2="300" y2="330" stroke="#d0d0d0" stroke-width="12" />
                        <line x1="400" y1="20" x2="400" y2="330" stroke="#d0d0d0" stroke-width="12" />
                        
                       
                        <text x="300" y="20" text-anchor="middle" font-family="Arial" font-size="14" fill="#666">Tiruppur City Map</text>
                        
                        
                        <rect x="290" y="140" width="120" height="70" fill="#e0e0e0" stroke="#a0a0a0" />
                        <text x="350" y="175" text-anchor="middle" font-family="Arial" font-size="10" fill="#666">SIDCO Industrial Estate</text>
                        
                       
                        <circle cx="330" cy="165" r="8" fill="#a87d34" />
                        <text x="350" y="190" text-anchor="middle" font-family="Arial" font-size="12" font-weight="bold" fill="#a87d34">Floris Knits</text>
                        
                        
                        <rect x="150" y="80" width="80" height="40" fill="#e0e0e0" stroke="#a0a0a0" />
                        <text x="190" y="105" text-anchor="middle" font-family="Arial" font-size="10" fill="#666">Railway Station</text>
                        
                        <rect x="400" y="80" width="80" height="40" fill="#e0e0e0" stroke="#a0a0a0" />
                        <text x="440" y="105" text-anchor="middle" font-family="Arial" font-size="10" fill="#666">Bus Terminal</text>
                        
                        <rect x="150" y="220" width="80" height="40" fill="#e0e0e0" stroke="#a0a0a0" />
                        <text x="190" y="245" text-anchor="middle" font-family="Arial" font-size="10" fill="#666">City Center</text>
