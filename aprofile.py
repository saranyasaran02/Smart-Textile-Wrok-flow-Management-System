...
for i in res:
    ...
    print("""
           ...
           <body>
               ...
               </div>""" % (i[0], i[0],i[0],i[0],i[0],i[0],i[0]))
    print("""
           <div class="content" id="content">
               <h2 class="mb-4" style="color:var(--text-color); font-weight:600;margin-top:30px;">Admin Profile</h2>
                       ...
                       <div class="modal-content">
                           ...
                           <div class="modal-body">
                               <form method="post" name="form" enctype="multipart/form-data">
                                   ...
                                   <div>
                                       <button type="submit" class="btn btn-dark" name="eisubmit">Update Image</button>
...
if editsubmit != None:
    ...
    print("""
           ...
           window.location.href="aprofile.py?id=%s"
           </script>
    """ % (editid))
...
if isubmit != None:
    ...
    x = """UPDATE admin SET image='%s' where Id='%s' """ % (fn, admin_id)
    cur.execute(x)
    con.commit()
