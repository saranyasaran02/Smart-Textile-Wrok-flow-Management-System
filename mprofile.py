                   ...
                   <div class="sidebar" id="sidebar">
                    ...
                    <div class="content" id="content">
                     ...
                     <div class="profile-card">
                         ...
                         </div>""" % (i[0], i[0], i[7], i[1], i[2], i[3], i[4]))
    print("""
...
if editsubmit != None:
    q = """update manager set name='%s', mail='%s', phone='%s' ,location='%s' where id='%s' """ % (
    ...
    print("""
           ...
           window.location.href="mprofile.py?id=%s"
           </script>
    """ % (id))
...
if isubmit != None:
    ...
    x = """update manager set image='%s' where id='%s' """ % (fn, admin_id)
    cur.execute(x)
    con.commit()
...
if psubmit:
    ...
    ch = "select password from manager where id=%s"
    cur.execute(ch, (chid,))
    result = cur.fetchone()
    ...
    if result:
        ...
        if currentpass != stored_password:
            ...
            update_query = "update manager set password=%s where id=%s"
