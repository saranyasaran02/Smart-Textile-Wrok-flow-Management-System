    ...
    print("""
           <div class="content" id="content">
               <div class="page-container">
                   <h2 class="section-header">Rejected Dealer</h2>
...
x = """select * from wholesaler where status='rejected' """
cur.execute(x)
res = cur.fetchall()
for i in res:
    dealer_id = i[0]
    ...
    <i class="fas fa-check-circle me-2"></i>Approve</button></td>
    </tr>
    """ % (i[1], i[2], i[3], i[4], i[5], i[6], i[10], i[11],dealer_id))
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">Approve wholesaler: %s</h4>
    ...
    """ % (dealer_id, i[1], user_id, password, i[3], i[1], dealer_id))
...
if Submit is not None and dealer_id is not None:
    ...
    try:
        ...
        window.location.href = "wrejected.py?id=%s";
        </script>
        """ % (Id))
